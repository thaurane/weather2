...
public class EventHandlerForge {
	...
	public void onRenderTick(TickEvent.RenderTickEvent event) {
		// Let Weather2 establish its normal rain/thunder visuals first.
		SceneEnhancer.renderTick(event);
		// Apply layer 1 overcast darkness last so Weather2 does not overwrite it.
		Layer1OvercastRenderer.onRenderTick(event);
	}
